...
class SemVerTestCase(unittest.TestCase):
  ...
  def test_bump_major(self):
    self.assertEqual(SemVer.parse('1.2.3').bump_major(), SemVer.parse('2.0.0'))

  def test_bump_minor(self):
    self.assertEqual(SemVer.parse('1.2.3').bump_minor(), SemVer.parse('1.3.0'))

  def test_bump_patch(self):
    self.assertEqual(SemVer.parse('1.2.3').bump_patch(), SemVer.parse('1.2.4'))
