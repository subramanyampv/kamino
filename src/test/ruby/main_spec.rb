...
RSpec.describe CommandFactory do
  describe '#create_command' do
    it 'should create a command with just options' do
      factory = CommandFactory.new(dummy: CommandWithOptions)
      options = {
        command: :dummy,
        hello: 'world'
      }
    ...
    it 'should create a command with provider' do
      ...
      factory = CommandFactory.new(dummy: CommandWithProvider)
      command = factory.create_command(options)
    ...
    it 'should create a command with git' do
      ...
      factory = CommandFactory.new(dummy: CommandWithGit)
      command = factory.create_command(options)
    ...
    it 'should create a command with file system' do
      ...
      factory = CommandFactory.new(dummy: CommandWithFileSystem)
      command = factory.create_command(options)
